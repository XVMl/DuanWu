...
{   
    ...
    {
        private static UIGrid iGrid = new();
        ...
        {
            Main.NewText("@");
            iGrid.Add(new TestElement(ModContent.Request<Texture2D>("DuanWu/Content/UI/choiceButton")));
            message = "NKA";
        }
    ...
    internal class TestElement: UIImageButton
    {
        ...
        public TestElement(Asset<Texture2D> texture) : base(texture)
        {
            text = new("");
            _texture = texture;
            Append(text);
